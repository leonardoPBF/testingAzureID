// pages/BandejaDeEntrada.tsx
import { useMsal } from "@azure/msal-react";
import { useGraphMail } from "../../hooks/useGraph";
...
export default function BandejaDeEntrada() {
  ...
  const { data: emails = [], isLoading } = useGraphMail(instance, query);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 to-slate-200 p-6">
      <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-2xl p-8">
        ...
        {isLoading ? (
          <p className="text-slate-500 text-center">Cargando correos...</p>
        ) : emails.length > 0 ? (
